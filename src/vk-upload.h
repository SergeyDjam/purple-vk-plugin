...
using UploadedCb = std::function<void(const picojson::value& result)>;
using UploadProgressCb = std::function<void(PurpleHttpConnection* http_conn, int processed, int total)>;
