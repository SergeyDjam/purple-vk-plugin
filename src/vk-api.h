...
void vk_call_api_ids(PurpleConnection* gc, const char* method_name, const CallParams& params,
                     const char* id_param_name, const uint64_vec& id_values, const CallSuccessCb& success_cb = nullptr,
                     const CallFinishedCb& call_finished_cb = nullptr, const CallErrorCb& error_cb = nullptr);
