...
// NOTE: Commented in purple-vk-plugin.
// #include "internal.h"
...
// NOTE: Added in purple-vk-plugin because libpurple 2.x does not contain this function.
static void
	...
	GList *values)
{
	...
	while (values) {
        ...
        // NOTE: Added in purple-vk-plugin. Vk.com returns expires= in Set-cookie in the following
        // format: "Fri, 05-Sep-2014 10:13:46 GMT". This does not get parsed as date (due to dashes?)
        // and, therefore, the whole Set-cookie gets rejected.
        expires = -1;
